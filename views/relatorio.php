...
$rcliente_proj   = $_REQUEST["rcliente_proj"];
...
$html2 .= "<form name='relatorio' action='relatorio' method='post'>";
...
$html2 .= "    <td><input type='text' name='rcliente_proj' id='rcliente_proj' value='$rcliente_proj'></td>";
...
if($tipo=="Projetos") 
{
	...
	if (strlen($rcliente_proj) > 0) { $SQL .= " and cd_cliente like '%".$rcliente_proj."%' "; }
